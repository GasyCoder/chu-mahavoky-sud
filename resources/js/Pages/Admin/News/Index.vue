                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="md:col-span-2 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea v-model="form.content" rows="12" class="w-full border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm font-mono"></textarea>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-white p-4 rounded border border-slate-200 shadow-sm">
                                        ...
                                        <input type="file" @input="form.image = $event.target.files[0]" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-slate-50 file:text-slate-700 hover:file:bg-slate-100">
                                    </div>
                                </div>
                            </div>
                        </div>
